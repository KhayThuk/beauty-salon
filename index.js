...
// ... โค้ดส่วนบนเดิมเหมือนของคุณทั้งหมด

function buildWelcomeMessage() {
  return {
    type: 'text',
    text: 'สวัสดีค่ะ ยินดีต้อนรับสู่ร้าน เรือนไทย Beauty Salon ✨\nข้อความนี้เป็นระบบอัตโนมัติ หากต้องการคุยกับพนักงานโดยตรง กรุณากด “ติดต่อแอดมิน” นะคะ',
    quickReply: {
      items: [
...
function buildServiceQuestion() {
  return {
    type: 'text',
    text: 'ต้องการใช้บริการอะไรคะ กรุณาเลือกจากเมนูด้านล่างหรือพิมพ์ชื่อบริการได้เลยค่ะ\nหากต้องการคุยกับแอดมินทันที กดปุ่ม “ติดต่อแอดมิน”',
    quickReply: {
      items: [
...
function buildReopenMenuMessage() {
  return {
    type: 'text',
    text: 'สวัสดีค่ะ กลับมาใช้งานอีกครั้งนะคะ\nนี่คือระบบอัตโนมัติ หากเป็นเรื่องคิวเดิมหรืออยากคุยกับพนักงาน กรุณากด “คุยกับพนักงาน/เช็กคิวเดิม”\nหากต้องการจองใหม่หรือเพิ่มคิว กด “จองคิวเพิ่มเติม” ได้เลยค่ะ\nหากต้องการติดต่อแอดมินทันที กด “ติดต่อแอดมิน”',
    quickReply: {
      items: [
...
// ... ส่วนอื่นๆของโค้ดเดิมเหมือนของคุณ
